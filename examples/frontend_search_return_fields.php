...
//N.B.: you should not create
// several instances of BxClient on the same page, make sure to save it in a static variable and to re-use it.
...
try {
    ...
    $exception = json_encode($bxClient->getThriftChoiceRequest(), true);
    if(!isset($print) || $print){
        echo $exception;
    }
}
